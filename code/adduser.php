...
<body>
<center>
<h2>Add a new Mama G's user</h2></br>
...
<tr><td>Hire Date:</td><td><input class="form-control" name="hiredate" type="text" id="hiredate" size="20" maxlength="20"/></td><td><a href="#" onclick="cal1x.select(document.forms[0].hiredate,'anchor_hiredate','yyyy-MM-dd'); return false;" name="anchor_hiredate" id="anchor_hiredate">select</a></td></tr>
</table><br/></br>
